...
namespace SistemaAFT.Data
{
	public class DbInitializer
	{
		public static void Initialize (ApplicationDbContext context)
		{
			...
			if (context.Genero.Any() || context.Estado_Civil.Any()|| context.Etnia.Any() || context.Tipo_Identidad.Any() || context.Municipio.Any() || context.Tipo_Telefono.Any() || context.Tipo_Compania.Any() || context.Tipo_Persona.Any() || context.Discapacidad.Any())
			{
				return;
			}
