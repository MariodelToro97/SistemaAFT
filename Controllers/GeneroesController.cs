...
namespace SistemaAFT.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GeneroID,Nombre_Genero")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GeneroID,Nombre_Genero")] Genero genero)
        {
