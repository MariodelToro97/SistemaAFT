...
namespace SistemaAFT.Controllers
{
    public class PersonasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Persona.Include(p => p.Estado_Civil).Include(p => p.Genero).Include(p => p.Tipo_Compania).Include(p => p.Tipo_Identidad).Include(p => p.Tipo_Telefono).Include(p => p.Tipo_Persona).Include(p => p.Etnia);
        ...
        public async Task<IActionResult> Create([Bind("PersonaID,correo,fechaNacimiento,nacionalidad,GeneroID,Estado_CivilID,Tipo_IdentidadID,telefono,Tipo_TelefonoID,Tipo_CompaniaID,Tipo_PersonaID,EtniaID,DiscapacidadID")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonaID,correo,fechaNacimiento,nacionalidad,GeneroID,Estado_CivilID,Tipo_IdentidadID,telefono,Tipo_TelefonoID,Tipo_CompaniaID, Tipo_PersonaID,EtniaID,DiscapacidadID")] Persona persona)
        {
